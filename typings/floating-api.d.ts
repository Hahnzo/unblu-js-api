...
declare module 'unblu-floating-js-api' {
    import { AgentAvailabilityChangeListener, AgentAvailableChangeListener, ConversationChangeListener, ConversationsChangeListener, NotificationCountChangeListener, PersonActivityListener, PersonChangeListener, UnbluApi } from 'unblu-floating-js-api/unblu-api';
    import { CallStateListener, ConnectionStateListener, Conversation, ConversationStateListener, CustomActionInvocationListener } from 'unblu-floating-js-api/shared/conversation';
    ...
    import { NewConversationRecipient } from "unblu-floating-js-api/shared/model/new-conversation-recipient";
    import { NewConversationRecipientType } from "unblu-floating-js-api/shared/model/new-conversation-recipient-type";
    ...
    import { ConversationParticipant } from "unblu-floating-js-api/shared/model/conversation-participant";
    import { ConversationParticipationType } from "unblu-floating-js-api/shared/model/conversation-participation-type";
...
declare module 'unblu-floating-js-api/unblu-static-api' {
    ...
    import { UnbluFloatingApiFactory } from "unblu-floating-js-api/shared/internal/unblu-floating-api";
    ...
    /**
        ...
        * ```
        */
    export class UnbluStaticApi implements UnbluFloatingApiFactory {
            /**
...
declare module 'unblu-floating-js-api/shared/model/new-conversation-recipient' {
    import { NewConversationRecipientType } from "unblu-floating-js-api/shared/model/new-conversation-recipient-type";
    /**
        * The recipient of a conversation
        */
...
declare module 'unblu-floating-js-api/shared/model/new-conversation-recipient-type' {
    export enum NewConversationRecipientType {
            /**
                * The recipient type for a conversation is an agent
                */
            AGENT = "AGENT",
...
declare module 'unblu-floating-js-api/shared/model/conversation-participant' {
    import { ConversationParticipationType } from "unblu-floating-js-api/shared/model/conversation-participation-type";
...
declare module 'unblu-floating-js-api/shared/model/conversation-participation-type' {
...
declare module 'unblu-floating-js-api/shared/internal/unblu-floating-api' {
    import { ApiState } from "unblu-floating-js-api/shared/api-state";
    import { InitializedUnbluApi } from "unblu-floating-js-api/shared/internal/initialized-unblu-api";
    /**
        * @hidden
        */
    export interface UnbluFloatingApi {
            api: UnbluFloatingApiFactory;
    }
    /**
        * @hidden
        */
    export interface UnbluFloatingApiFactory {
